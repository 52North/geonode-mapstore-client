...
function getStyleOptions(layer) {
  const mapLayerStyles = (
    layer?.extendedParams?.mapLayer?.extra_params?.styles || []
...
function OptionLabel({ canEdit, label, style, value, buttons = [] }) {
  return (
    <div
      style={{ display: "flex", width: "100%", alignItems: "center", ...style }}
    >
...
function GeoNodeStyleSelector({ node, onChange, buttons }) {
